...
public class AdminNoticeController {
	...
	@RequestMapping(value="/jr41/adminNotice" , method=RequestMethod.GET)
	...
	@RequestMapping(value="/jr41/adminInsertNotice", method=RequestMethod.GET)
	public String writeAdminNotice() throws Exception {
		return "/admin/AdminNoticeInsert";
	}
	
	@RequestMapping(value="/jr41/noticeInserting", method=RequestMethod.POST)
	public String insertAdminNotice(AdminNoticeDto adnot, MultipartHttpServletRequest multiFile) throws Exception {
		...
		return "redirect:/jr41/adminNotice";
	}
	
	@RequestMapping(value="/jr41/adminNoticeDetail/{noticeIdx}", method=RequestMethod.GET)
	...
	@RequestMapping(value="/jr41/adminNoticeUpdate/{noticeIdx}", method=RequestMethod.POST)
	public String updateAdminNotice(AdminNoticeDto adnot) throws Exception {
		adminNoticeService.updateAdminNotice(adnot);
		return "redirect:/jr41/adminNotice";
	}
	
	@RequestMapping(value="/jr41/adminNoticeDelete/{noticeIdx}", method=RequestMethod.DELETE)
