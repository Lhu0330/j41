...
public class AdminInquiryController {
	...
	@RequestMapping(value="/jr41/adminInquiry" , method=RequestMethod.GET)
...
//	이부분은 등록부분인데 문의사항은 답변하기만 있으면 되어서 비활성화 시킴
	@RequestMapping(value="/jr41/adminInsertInquiry", method=RequestMethod.GET)
	public String writeAdminInquiry() throws Exception {
		return "/admin/AdminRegistrationInquiry";
	}
	
	@RequestMapping(value="/jr41/InquiryInserting", method=RequestMethod.POST)
	public String insertAdminInquiry(AdminInquiryDto adnot, MultipartHttpServletRequest multiFile) throws Exception {
		...
		return "redirect:/jr41/adminInquiry";
	}
	
	@RequestMapping(value="/jr41/adminInquiryDetail/{inquiryIdx}", method=RequestMethod.GET)
	...
	@RequestMapping(value="/jr41/adminInquiryUpdate/{inquiryIdx}", method=RequestMethod.POST)
	public String updateAdminInquiry(AdminInquiryDto adnot) throws Exception {
		adminInquiryService.updateAdminInquiry(adnot);
		return "redirect:/jr41/adminInquiry";
	}
//	문의 삭제는 문의올린측에서 하는걸로
	@RequestMapping(value="/jr41/adminInquiryDelete/{inquiryIdx}", method=RequestMethod.POST)
